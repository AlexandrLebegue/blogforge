...
export default function ArticlePageClient({ article, headings }: ArticlePageClientProps) {
  ...
  const getCategoryConfig = () => {
    switch (article.category) {
      case '{{CAT1}}':
        return { emoji: '{{CAT1_ICON}}', label: '{{CAT1_LABEL}}', color: 'from-green-500 to-green-600' };
      case '{{CAT2}}':
        return { emoji: '{{CAT2_ICON}}', label: '{{CAT2_LABEL}}', color: 'from-purple-500 to-purple-600' };
      case '{{CAT3}}':
        return { emoji: '{{CAT3_ICON}}', label: '{{CAT3_LABEL}}', color: 'from-yellow-500 to-yellow-600' };
      default:
